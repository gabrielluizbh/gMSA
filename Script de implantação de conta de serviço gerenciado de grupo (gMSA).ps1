...
# Passo 2 - Crie uma GMSA e vincule-o a dois (ou mais) servidores Windows.
...
# Passo 5  - Faça logon como um trabalho em lotes (Log on as a batch job).
...
Get-ADServiceAccount -Identity gmsa-conta -Properties LastLogonDate
